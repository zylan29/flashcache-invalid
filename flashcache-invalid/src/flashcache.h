...
void flashcache_dirty_writeback_range(struct cache_c *dmc, sector_t start_block, int len);
void flashcache_purge_block_range(struct cache_c *dmc, sector_t start, int num_sectors);
